// ==UserScript==
// @name         Fm view video 3.0
// @namespace    http://tampermonkey.net/
// @version      2024-01-23
// @description  try to take over the world!
// @author       You
// @match        https://academy.forumias.com/406/*/*
...
(function() {
    ...
    const pb = atob(p[2]);
//    const otp = p[3];
    document.body.innerHTML = '<iframe src="' + pb + '" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope picture-in-picture" allowfullscreen="" crossorigin="anonymous" frameborder="0" style="border: 0px; max-width: 100%; position: absolute; top: 0px; left: 0px; height: 100%; width: 100%;"></iframe>'
